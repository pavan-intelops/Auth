...
func main() {
	...
	auth_serviceController, err := restcontrollers.NewAuth_serviceController()
	if err != nil {
	...
	v1 := router.Group("/v1")
	{
		...
		v1.GET("/auth_services/:id", auth_serviceController.FetchAuth_service)

		v1.DELETE("/auth_services/:id", auth_serviceController.DeleteAuth_service)
